...
En Sistemasdeconsultasmedicas-labels_es.properties:
Sistemasdeconsultasmedicas=Tu aplicación
Sistemasdeconsultasmedicas[description]=Tu aplicación hace esto y lo otro

En Sistemasdeconsultasmedicas-messages_en.properties:
